...
Entrada a **Build with Gemini XPRIZE** (xprize.devpost.com) · Categoría **Money & Financial Access**.

## Qué hace

1. Subes cartola o estado de cuenta (pdf o foto) — o lo escribes
...
5. Escribes por WhatsApp, recibes el link de pago de monto fijo ($2.990) y el pack llega por ahí mismo
...
```bash
curl -s "https://cartola-clara.vercel.app/api/health"
